...
UPnPUtils.prototype.invokeAction = function(params, callback) {
    ...
    if (cookies) {
        if (!Array.isArray(cookies)) {
            throw new Error(
                'The value of "cookies" is invalid. It must be an array.'
            );
    ...
    if (action && typeof action !== "string") {
        throw new Error(
            'The value of "action" is invalid. It must be a string.'
        );
    }
...
UPnPUtils.prototype._postAction = function(
    ourl,
    soap_action,
    cookies,
    soap,
...
UPnPUtils.prototype.startDiscovery = function(params) {
    if (this.discovery_started === true) {
        throw new Error(
            "The startDiscovery() method can not be invoked simultaneously."
        );
    }
